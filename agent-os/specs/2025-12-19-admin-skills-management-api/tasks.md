...
- [ ] 1.0 Complete GraphQL DTOs and schema layer
  ...
  - [ ] 1.2 Create CreateSkillInput DTO
  ...
  - [ ] 1.3 Create UpdateSkillInput DTO
  ...
  - [ ] 1.5 Register Discipline enum for GraphQL
  ...
  - [ ] 1.6 Ensure DTO layer tests pass
...
- [ ] 2.0 Complete skills service layer
  - [ ] 2.1 Write 2-8 focused tests for service methods
    - Limit to 2-8 highly focused tests maximum
  ...
  - [ ] 2.2 Create SkillsService with constructor
  ...
  - [ ] 2.5 Implement createSkill method
  ...
  - [ ] 2.6 Implement updateSkill method
  ...
  - [ ] 2.7 Implement disableSkill method
  ...
  - [ ] 2.8 Implement enableSkill method
...
- [ ] 3.0 Complete skills resolver layer
  - [ ] 3.1 Write 2-8 focused tests for resolver authorization
    - Limit to 2-8 highly focused tests maximum
  ...
  - [ ] 3.2 Create SkillsResolver with constructor
  ...
  - [ ] 3.3 Implement createSkill mutation
  ...
  - [ ] 3.6 Implement enableSkill mutation
    - Use @Mutation(() => Skill) decorator
    - Apply guards: @UseGuards(JwtAuthGuard, RolesGuard)
    - Apply role decorator: @Roles(Role.ADMIN)
    - Parameters: @Args('id') id: string
    ...
    - Note: Single id argument, NOT wrapped in input type per spec
  - [ ] 3.7 Ensure resolver layer tests pass
...
- [ ] 4.0 Complete module configuration and test coverage
  - [ ] 4.1 Create SkillsModule
  ...
  - [ ] 4.5 Analyze test coverage gaps for THIS feature only
  ...
  - [ ] 4.8 Verify GraphQL schema generation
