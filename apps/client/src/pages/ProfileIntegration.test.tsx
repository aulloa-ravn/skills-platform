...
describe("Profile Integration Tests", () => {
  ...
  it("should handle empty profile data gracefully", () => {
    ...
    expect(
      screen.getByText("No validated skills in inventory")
    ).toBeInTheDocument();
    expect(screen.getByText("No pending skills")).toBeInTheDocument();
    expect(
      screen.getByText("No seniority history available")
    ).toBeInTheDocument();
